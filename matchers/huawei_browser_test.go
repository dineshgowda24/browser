...
func TestNewHuaweiBrowser(t *testing.T) {
	Convey("Subject: #NewHuaweiBrowser", t, func() {
		Convey("It should return a new HuaweiBrowser instance", func() {
			So(NewHuaweiBrowser(""), ShouldHaveSameTypeAs, &HuaweiBrowser{})
		})
	})
}
	...
	Convey("Subject: #Version", t, func() {
		Convey("When the version is matched", func() {
			Convey("It should return the correct version", func() {
				...
				So(NewHuaweiBrowser(ua.Windows).Version(), ShouldEqual, "12.1.3.303")
				So(NewHuaweiBrowser(ua.Android).Version(), ShouldEqual, "14.0.2.300")
			})
		})
		...
		Convey("When the version is not matched", func() {
			Convey("It should return default version", func() {
				...
				So(NewHuaweiBrowser(ua.Android).Version(), ShouldEqual, "0.0")
			})
		})
	})
}
	...
	Convey("Subject: #Match", t, func() {
		Convey("When user agent matches HuaweiBrowser", func() {
			Convey("It should return true", func() {
				ua := testUserAgents["huawei-browser"]
				So(NewHuaweiBrowser(ua.Windows).Match(), ShouldBeTrue)
				So(NewHuaweiBrowser(ua.Android).Match(), ShouldBeTrue)
			})
		})
		...
		Convey("When user agent does not match HuaweiBrowser", func() {
			Convey("It should return false", func() {
				ua := testUserAgents["uc-browser"]
				So(NewHuaweiBrowser(ua.Android).Match(), ShouldBeFalse)
			})
		})
	})
}
